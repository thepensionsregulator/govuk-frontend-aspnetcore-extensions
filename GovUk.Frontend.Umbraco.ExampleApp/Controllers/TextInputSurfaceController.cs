...
{
    public class TextInputSurfaceController : SurfaceController
    {
        public TextInputSurfaceController(IUmbracoDatabaseFactory umbracoDatabaseFactory,
        ...
        public IActionResult Index(TextInputViewModel viewModel)
        {
            ...
            return View("TextInput", viewModel);
        }
