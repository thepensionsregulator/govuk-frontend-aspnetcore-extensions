...
namespace ThePensionsRegulator.GovUk.Frontend.Umbraco
{
    ...
    {
        public static IApplicationBuilder UseTprGovUkFrontendUmbraco(this IApplicationBuilder app, IOptions<MvcOptions> mvcOptions, IUmbracoContextAccessor umbracoContextAccessor, IPublishedValueFallback publishedValueFallback)
        {
            if (app is null)
            {
