...
import { PostcodeNormaliser } from "../../wwwroot/tpr/address-lookup/postcode-normaliser.js";

describe("Postcode normaliser", () => {
    const normaliser = new PostcodeNormaliser();
    ...
    ********************************************************************************/
    ...
    it.each([
        ...
        const result = normaliser.normalise(userInput);
