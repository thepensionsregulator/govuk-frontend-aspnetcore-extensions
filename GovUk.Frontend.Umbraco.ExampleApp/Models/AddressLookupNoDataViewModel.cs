...
namespace GovUk.Frontend.Umbraco.ExampleApp.Models
{
    public class AddressLookupNoDataViewModel
    {
        ...
        [MaxLength(100, ErrorMessage = nameof(ShippingAddressLine1))]
        public string? ShippingAddressLine1 { get; set; }

        [MaxLength(101, ErrorMessage = nameof(ShippingAddressLine2))]
        public string? ShippingAddressLine2 { get; set; }

        [Required(ErrorMessage = nameof(ShippingSomethingReallyRandom))]
        [MaxLength(102, ErrorMessage = nameof(ShippingSomethingReallyRandom))]
        public string? ShippingSomethingReallyRandom { get; set; }

        [MaxLength(103, ErrorMessage = nameof(ShippingCounty))]
        ...
        [MaxLength(11, ErrorMessage = nameof(ShippingPostcode))]
