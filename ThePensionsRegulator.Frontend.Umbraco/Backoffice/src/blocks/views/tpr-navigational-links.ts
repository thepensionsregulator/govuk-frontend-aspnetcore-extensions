...
interface ITprNavigationalLinksContent extends UmbBlockDataType {
    text: UmbPropertyEditorRteValueType;
}

interface ITprNavigationalLinksSettings extends UmbBlockDataType {
}


@customElement('tpr-navigational-links')
export class TprNavigationalLinksView extends UmbElementMixin(LitElement) implements UmbBlockEditorCustomViewElement {

    @property({ attribute: false })
    content?: ITprNavigationalLinksContent;

    @property({ attribute: false })
    settings?: ITprNavigationalLinksSettings;
...
export default TprNavigationalLinksView;