...
namespace ThePensionsRegulator.Umbraco.Testing
{
    ...
    public class UmbracoTestContext : IDisposable
    {
        ...
        /// <summary>
        /// Provides access to the current HTTP context for services under test.
        /// </summary>
        public Mock<IHttpContextAccessor> HttpContextAccessor { get; private init; } = new();
...
#pragma warning restore CS0612 
        ...
        private void SetupServices()
        {
            ...
            SetupService(HttpContextAccessor.Object);
