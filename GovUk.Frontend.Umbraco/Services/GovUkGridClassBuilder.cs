namespace GovUk.Frontend.Umbraco.Services
{
    public static class GovUkGridClassBuilder
    {
        ...
        public static string BuildGridColumnClass(string? columnSizeClass, string? fromDesktopClass, string? customClass, string? forBlockOfContentTypeAlias = null, bool inBlockGridArea = false)
        {
            ...
            if (string.IsNullOrEmpty(columnClass)) { columnClass = DefaultColumnClass(forBlockOfContentTypeAlias, inBlockGridArea); }
        ...
        private static string DefaultColumnClass(string? forBlockOfContentTypeAlias, bool inBlockGridArea)
        {
            return inBlockGridArea || forBlockOfContentTypeAlias == ElementTypeAliases.Caption || forBlockOfContentTypeAlias == ElementTypeAliases.PageHeading ? "govuk-grid-column-full" : "govuk-grid-column-two-thirds-from-desktop";
        }
    }
}
