...
{
    public class CheckboxesSurfaceController : SurfaceController
    {
        public CheckboxesSurfaceController(IUmbracoDatabaseFactory umbracoDatabaseFactory,
        ...
        public IActionResult Index(CheckboxesViewModel viewModel)
        {
            ...
            return View("Checkboxes", viewModel);
        }
