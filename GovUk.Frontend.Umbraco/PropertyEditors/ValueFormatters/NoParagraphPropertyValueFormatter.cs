...
namespace GovUk.Frontend.Umbraco.PropertyEditors.ValueFormatters
{
    ...
    /// </summary>
    public class NoParagraphPropertyValueFormatter : TipTapPropertyValueFormatterBase, IPropertyValueFormatter
    {
        /// <inheritdoc />
        ...
        /// </remarks>
        public object FormatValue(object value) => RemoveWrappingParagraphIfNoClass(ApplyGovUkTypographyToTipTap(value));
    }
}
