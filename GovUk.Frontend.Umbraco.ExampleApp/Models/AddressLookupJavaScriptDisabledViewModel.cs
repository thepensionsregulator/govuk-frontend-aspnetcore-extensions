...
{
    public class AddressLookupJavaScriptDisabledViewModel
    {
        public AddressLookupJavaScriptDisabled? Page { get; set; }
        ...
        [Required(ErrorMessage = nameof(ShippingCountryCode))]
        ...
        [Required(ErrorMessage = nameof(BillingCountryCode))]
