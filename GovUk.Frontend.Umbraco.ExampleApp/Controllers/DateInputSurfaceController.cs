...
{
    public class DateInputSurfaceController : SurfaceController
    {
        public DateInputSurfaceController(IUmbracoDatabaseFactory umbracoDatabaseFactory,
        ...
        public IActionResult Index(DateInputViewModel viewModel)
        {
            ...
            return View("DateInput", viewModel);
        }
