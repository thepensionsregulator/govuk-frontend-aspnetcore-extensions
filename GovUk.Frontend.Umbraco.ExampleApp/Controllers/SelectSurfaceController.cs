...
{
    public class SelectSurfaceController : SurfaceController
    {
        public SelectSurfaceController(IUmbracoDatabaseFactory umbracoDatabaseFactory,
        ...
        public IActionResult Index(SelectViewModel viewModel)
        {
