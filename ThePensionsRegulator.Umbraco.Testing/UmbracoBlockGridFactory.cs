...
namespace ThePensionsRegulator.Umbraco.Testing
{
    ...
    public class UmbracoBlockGridFactory
    {
        ...
        {
            return new OverridableBlockGridArea(blockGridItems, alias, rowSpan, columnSpan, new TestPublishedElementFactory());
        }
        ...
        {
            return new OverridableBlockGridItem(CreateBlock(content), new TestPublishedElementFactory());
        }
        ...
        {
            return new OverridableBlockGridItem(CreateBlock(content, settings), new TestPublishedElementFactory());
        }
        ...
        {
            return new OverridableBlockGridItem(CreateBlock(CreateContentOrSettings(contentTypeAliasForContent).Object), new TestPublishedElementFactory());
        }
