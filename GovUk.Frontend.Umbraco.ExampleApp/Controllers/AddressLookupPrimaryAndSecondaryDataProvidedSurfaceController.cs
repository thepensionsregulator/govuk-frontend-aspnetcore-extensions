...
{
    public class AddressLookupPrimaryAndSecondaryDataProvidedSurfaceController : SurfaceController
    {
        public AddressLookupPrimaryAndSecondaryDataProvidedSurfaceController(IUmbracoDatabaseFactory umbracoDatabaseFactory,
        ...
        public IActionResult Index(AddressLookupPrimaryAndSecondaryDataProvidedViewModel viewModel)
        {
            ...
            return View("AddressLookupPrimaryAndSecondaryDataProvided", viewModel);
        }
    }
}
