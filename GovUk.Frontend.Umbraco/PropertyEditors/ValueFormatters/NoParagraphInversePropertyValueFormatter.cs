...
namespace GovUk.Frontend.Umbraco.PropertyEditors.ValueFormatters
{
    ...
    /// </summary>
    public class NoParagraphInversePropertyValueFormatter : TipTapPropertyValueFormatterBase, IPropertyValueFormatter
    {
        /// <inheritdoc />
        ...
        public object FormatValue(object value) => RemoveWrappingParagraphIfNoClass(
            ApplyGovUkTypographyToTipTap(value, new TypographyOptions { BackgroundType = BackgroundType.Dark })
        );
    }
}
