...
namespace ThePensionsRegulator.Frontend.Umbraco.PropertyEditors.ValueFormatters
{
    ...
    /// </summary>
    public class NoParagraphsPropertyValueFormatter : RichTextPropertyValueFormatterBase, IPropertyValueFormatter
    {
        /// <inheritdoc />
        ...
        /// </remarks>
        public object FormatValue(object value) => RemoveWrappingParagraphs(ApplyGovUkTypographyToRichText(value));
