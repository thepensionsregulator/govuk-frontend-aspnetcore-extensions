...
namespace GovUk.Frontend.Umbraco.PropertyEditors.ValueFormatters
{
    ...
    /// </summary>
    public class GovUkTypographyPropertyValueFormatter : IPropertyValueFormatter
    {
        /// <inheritdoc />
        ...
        /// </remarks>
        public object FormatValue(object value) => new HtmlEncodedString(GovUkTypography.Apply(value is IHtmlEncodedString html ? html.ToHtmlString() : value as string));
    }
}
