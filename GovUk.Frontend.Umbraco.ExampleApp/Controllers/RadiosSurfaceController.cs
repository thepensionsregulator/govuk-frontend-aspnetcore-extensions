...
{
    public class RadiosSurfaceController : SurfaceController
    {
        public RadiosSurfaceController(IUmbracoDatabaseFactory umbracoDatabaseFactory,
        ...
        public IActionResult Index(RadiosViewModel viewModel)
        {
