...
{
    public class AddressLookupNoDataSurfaceController : SurfaceController
    {
        public AddressLookupNoDataSurfaceController(IUmbracoDatabaseFactory umbracoDatabaseFactory,
        ...
        public IActionResult Index(AddressLookupNoDataViewModel viewModel)
        {
