...
using CopiedInternalClasses = ThePensionsRegulator.GovUk.Frontend.Umbraco.ModelBinding;
...
namespace ThePensionsRegulator.GovUk.Frontend.Umbraco.ModelBinding
{
    ...
    public class UmbracoDateInputModelBinderProvider : IModelBinderProvider
    {
            ...
            IUmbracoHelperAccessor umbracoHelperAccessor)
        {
            ...
            {
                { DateTimeDateInputModelConverter.ModelType, new CopiedInternalClasses.DateTimeDateInputModelConverter() },
                { DateOnlyDateInputModelConverter.ModelType, new CopiedInternalClasses.DateOnlyDateInputModelConverter() }
            };
