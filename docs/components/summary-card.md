        ...
        ) : RenderController(logger, compositeViewEngine, umbracoContextAccessor)
{
    ...
    public override IActionResult Index()
    {
        ...
        block.Content.OverrideSummaryCardActions(new[] { cardAction }, _publishedContentTypeCache, _variationContextAccessor, _publishedValueFallback, _publishedElementFactory, _filterStoreAccessor);
