...
namespace ThePensionsRegulator.GovUk.Frontend.TagHelpers
{
    ...
    [RestrictChildren("govuk-input", "govuk-radios", "govuk-select", "govuk-character-count", "govuk-checkboxes", "govuk-fieldset", "govuk-textarea", "govuk-date-input", "govuk-date-input-options", "govuk-file-upload")]
