...
namespace ThePensionsRegulator.Frontend.Umbraco.PropertyEditors.ValueFormatters
{
    ...
    /// </summary>
    public class NoParagraphsPropertyValueFormatter : TipTapPropertyValueFormatterBase, IPropertyValueFormatter
    {
        /// <inheritdoc />
        ...
        /// </remarks>
        public object FormatValue(object value) => RemoveWrappingParagraphs(ApplyGovUkTypographyToTipTap(value));
